...
class _Level2PageState extends State<level2page> {
  ...
  List<Question> questions = [
    Question('Question 1', 'assets/images/level1_image.png', ['Aplpe', 'Apple', 'Appel', 'Appla'], 1),
    Question('Question 2', 'assets/images/level2_image.png', ['Orange', 'Oranga', 'Oranag', 'Oragne'], 0),
    Question('Question 3', 'assets/images/level3_image.png', ['Maago', 'Magon', 'Manga', 'Mango'], 3),
    Question('Question 4', 'assets/images/level4_image.png', ['Bnnana', 'Benana', 'Banana', 'Benena'], 2),
    Question('Question 5', 'assets/images/level5_image.png', ['Fihs', 'Fish', 'Fesh', 'Fseh'], 1),
    Question('Question 6', 'assets/images/level6_image.png', ['Car', 'cvn', 'cur', 'cer'], 0),
    Question('Question 7', 'assets/images/level7_image.png', ['Bike', 'Bicycle', 'Bicyle', 'Bicycla'], 1),
    Question('Question 8', 'assets/images/level8_image.png', ['Phona', 'Phone', 'Pone', 'Phona'], 1),
    Question('Question 9', 'assets/images/level9_image.png', ['Bad', 'Bed', 'Bud', 'Beed'], 1),
    Question('Question 10', 'assets/images/level10_image.png', ['Bas', 'Bes', 'Bus', 'Bud'], 2),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Level 2 Choose the Option !'),
      ),
      body: Column(
